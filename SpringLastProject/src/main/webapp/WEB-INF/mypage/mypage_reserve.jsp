 ...
 <div id="mypageApp">
   <table class="table">
    ...
    <tr v-for="vo in reserve_list">
      ...
      <td class="text-center">
        <buttton class="btn-xs btn-success" v-if="vo.isReserve===1" @click="foodInfo(vo.fno,vo.rno)">예약완료</buttton>
        <buttton class="btn-xs btn-danger" v-else>예약대기</buttton>
      </td>
    </tr>
   </table>
   <table class="table" v-show="isShow">
   	<tr>
   		<td colspan="3"><h4>맛집정보</h4></td>
   	</tr>
   	<tr>
   	...
   	<tr>
   		...
   		<td width="50%">{{reserve_info.fvo.}}</td>
   	</tr>
   	<tr>
