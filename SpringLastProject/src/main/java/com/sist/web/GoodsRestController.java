...
public class GoodsRestController {
	...
	@GetMapping(value="goods/list.vue.do", produces="text/plain;charset=UTF-8")
	...
	public String goods_detail(int no) throws Exception{
		...
		temp=temp.replaceAll("[^0-9]","");//숫자 외 나머지 제거
	...
	@GetMapping(value="goods/chat_cancel.do", produces="text/plain;charset=UTF-8")
